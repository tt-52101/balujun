...
import { GetNotificationSettingsOutput, NotificationServiceProxy, UpdateNotificationSettingsInput, NotificationSubscriptionDto } from '@shared/service-proxies/service-proxies';
...
export class NotificationSettingsComponent extends ModalComponentBase implements OnInit {
